...
// Modify the following line to include different policy implementations
#include "./p4.p4"
...
blackbox stateful_alu read_conn_1 {
    ...
    update_lo_1_value: meta.ctx_dec;
...
control MyIngress
{
   ...
   } else if (meta.cache_dec == 0) {
      // cache is empty, this conn is unseen
